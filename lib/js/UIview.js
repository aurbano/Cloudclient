...
var UI = {
	...
	drawItem : function(file, dom){
		...
		dom.append('<div class="item"><a href="'+href+'" id="'+file.name+'" rel="'+file.type+'" class="'+classes+'"><div class="icon '+type+'" style="'+style+'">'+extra+'</div><div class="name">'+file.name+'</div></a></div>');
	},
